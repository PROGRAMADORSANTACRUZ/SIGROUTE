...
export interface Modulo {
  ...
  label: string;
  grupo: "Planeación" | "Ejecución" | "Plantillas TAT" | "Configuración";
...
export const MODULOS: Modulo[] = [
  ...
  // ── Plantillas TAT (módulo propio) ─────────────────────────────────────
  { key: "/plantillas-tat/agropecuaria", label: "Plantilla TAT Agropecuaria", grupo: "Plantillas TAT", permiso: "plantillas_tat.ver" },
