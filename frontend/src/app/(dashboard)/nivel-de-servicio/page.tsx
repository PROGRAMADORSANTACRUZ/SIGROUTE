...
export default function NivelServicioPage() {
  const puedeEditar = usePermiso("distrilog.nivel_servicio.editar");
        ...
        {loading ? (
          ...
          <>
            ...
            {STATS_ESTADOS.map((e) => {
              ...
              const pct = allRows.length > 0 ? Math.round((stats[e] / allRows.length) * 100) : 0;
              return (
                <button key={e}
                ...
                >
                  ...
                  <div className="mt-1 flex items-baseline gap-2">
                    <p className={`text-2xl font-bold ${s.text}`}>{stats[e]}</p>
                    <p className={`text-xs font-semibold ${s.text} opacity-80`}>{pct}%</p>
                  </div>
                    ...
                    <tr key={key} className="hover:bg-[#f9fbf7]">
                      ...
                      <td className="px-2 py-2.5">
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className={`flex h-8 w-8 items-center justify-center rounded-lg border transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${
                      ...
                      <td className="px-4 py-2.5">
                        <select
                          ...
                          className="w-52 rounded-lg border border-[#dfe4e0] bg-white px-2.5 py-1.5 text-xs text-[#14352a] outline-none transition focus:border-[#2f8f4e] focus:ring-1 focus:ring-[#2f8f4e]/20 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          <option value="">—</option>
                      ...
                      <td className="px-4 py-2.5">
                        <select
                          ...
                          className="w-44 rounded-lg border border-[#dfe4e0] bg-white px-2.5 py-1.5 text-xs text-[#14352a] outline-none transition focus:border-[#2f8f4e] focus:ring-1 focus:ring-[#2f8f4e]/20 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          <option value="">—</option>
                      ...
                      <td className="px-4 py-2.5">
                        <input
                          ...
                          className="w-52 rounded-lg border border-[#dfe4e0] bg-white px-2.5 py-1.5 text-xs text-[#14352a] placeholder:text-[#b0b9b3] outline-none transition focus:border-[#2f8f4e] focus:ring-1 focus:ring-[#2f8f4e]/20 disabled:cursor-not-allowed disabled:opacity-60"
                        />
                      </td>
                      {/* Resolución */}
                      <td className="px-4 py-2.5">
