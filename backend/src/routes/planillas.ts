...
router.post("/", requireAuth, requirePermiso("distrilog.planificacion_dl.editar"), async (req, res, next) => {
  try {
...
router.patch("/:id", requireAuth, requirePermiso("distrilog.planificacion_dl.editar"), async (req, res, next) => {
  try {
...
router.delete("/:id", requireAuth, requirePermiso("distrilog.planificacion_dl.editar"), async (req, res, next) => {
  try {
...
router.post("/:id/anular", requireAuth, requirePermiso("distrilog.planificacion_dl.editar"), async (req, res, next) => {
  try {
    const id = String(req.params.id);
